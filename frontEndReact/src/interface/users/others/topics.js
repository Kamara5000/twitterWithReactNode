...
let {name, username}=props.user;
        ...
        return(
            ...
            <div className='col-12 mt-2' style={{}}>
                         <div className="card mb-3" style={{maxWidth: '18rem',backgroundColor:'#F7F9F9', borderRadius:'20px'}}>
                            <div className="card-header bg-transparent">Topics to follow</div>
                            <ul className="list-group list-group-flush ">
                                <li className="list-group-item bg-transparent">topic to follow</li>
                                <li className="list-group-item bg-transparent">topic to follow</li>
                                <li className="list-group-item bg-transparent">topic to follow</li>
                            </ul>
    ...
    const mapStateToProps =state=>{
      ...
      export default connect(mapStateToProps, addFunctionToRedux)(Topics);
