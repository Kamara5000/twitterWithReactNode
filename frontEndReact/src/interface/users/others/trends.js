...
let {name, username}=props.user;
            ...
            <div className="container-fluid">
                    ...
                    <div className='col-12 mt-2' style={{}}>
                         <div className="card mb-3" style={{maxWidth: '18rem',backgroundColor:'#F7F9F9', borderRadius:'20px'}}>
                            <div className="card-header bg-transparent">Trends for you</div>
                            <ul className="list-group list-group-flush ">
                                <li className="list-group-item bg-transparent">trends</li>
                                <li className="list-group-item bg-transparent">trends</li>
                                <li className="list-group-item bg-transparent">trends</li>
                            </ul> 
    ...
    const mapStateToProps =state=>{
      ...
      export default connect(mapStateToProps, addFunctionToRedux)(Trends);
